// src/main/java/com/web/taller1/services/UsuarioService.java
...
public class UsuarioService {
    ...
    public UsuarioDTO createUsuario(UsuarioDTO usuarioDTO) {
        ...
        usuario.setPassword(encodedPassword);  // Encriptar contraseña
        usuario.setTelefono(usuarioDTO.getTelefono());
        Usuario nuevoUsuario = usuarioRepository.save(usuario);

        // Log para ver la contraseña encriptada
        System.out.println("Contraseña encriptada al crear usuario: " + encodedPassword);
